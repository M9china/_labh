  ...
  return (
    <div className="pt-[5rem] bg-white px-4">
      ...
      <div className="mt-5">
        ...
        <div className="bg-blue-600 text-white flex space-x-1 justify-center items-center rounded mt-5">
          <button className="font-semibold rounded px-4 py-2">
            Add to cart
          </button>
          <svg
            xmlns="http://www.w3.org/2000/svg"
